    ...
    <Drawer title="新增/修改" v-model="formState" width="720" :mask-closable="true">
      <Form :model="formData" ref="formValidate" :rules="ruleValidate">
        <Row :gutter="32">
          ...
          <Col span="12">
            <FormItem label="自动播放距离" label-position="top" prop="lat">
              <Input v-model="formData.distance" placeholder="请输入距离"/>
            </FormItem>
          </Col>
          <Col span="12">
            <FormItem label="经度" label-position="top" prop="lon">
              <Input v-model="formData.gaoDeLon" placeholder="请输入经度"/>
            </FormItem>
          </Col>
          <Col span="12">
            <FormItem label="纬度" label-position="top" prop="lat">
              <Input v-model="formData.gaoDeLat" placeholder="请输入纬度"/>
            </FormItem>
          </Col>
          <Col span="24">
            <FormItem label="音频url" label-position="top" prop="lat">
              <Input v-model="formData.voiceUrl" placeholder="请输入url"/>
            </FormItem>
          </Col>
        </Row>
      </Form>
